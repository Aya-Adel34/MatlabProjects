###########################################################################
## Makefile generated for Simulink model 'task2'. 
## 
## Makefile     : task2.mk
## Generated on : Wed Mar 02 00:38:44 2022
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = task2_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = task2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/task2.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/task2_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=task2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/task2_ert_rtw/task2.c

MAIN_SRC = $(START_DIR)/task2_ert_rtw/ert_main.c
