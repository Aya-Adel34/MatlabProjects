###########################################################################
## Makefile generated for Simulink model 'task1'. 
## 
## Makefile     : task1.mk
## Generated on : Wed Mar 02 00:23:07 2022
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/task1.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/ITI_Embedded_Systems/matlabCousre/mbd/workspace
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = task1_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = task1_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/task1.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/task1_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=task1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/task1_ert_rtw/task1.c

MAIN_SRC = $(START_DIR)/task1_ert_rtw/ert_main.c
